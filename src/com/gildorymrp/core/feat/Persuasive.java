...
public class Persuasive implements PassiveFeat {

	@Override
	public String getDescription() {
		return "+2 bonus on Bluff and Intimidate checks";
	}
	...
	public Map<Skill, Integer> getStatBonuses() {
		...
		statBonuses.put(Skill.BLUFF, 2);
		statBonuses.put(Skill.INTIMIDATE, 2);
		return statBonuses;
	}
